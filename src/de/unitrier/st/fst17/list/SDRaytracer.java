...
public class SDRaytracer extends JFrame
{
	...
	{ mainLight, new Light(new Vec3D(100, 200, 300), new RGB(0.5f, 0, 0.0f)),
	...
	{
		return new RGB((c1.red + c2.red * ratio), (c1.green + c2.green * ratio), (c1.blue + c2.blue * ratio));
	}
	...
	void createScene()
	{
		...
		Cube.addCube(triangles, 0, 35, 0, 10, 10, 10, new RGB(0.3f, 0, 0), 0.4f); // rot,
																					// klein
		Cube.addCube(triangles, -70, -20, -20, 20, 100, 100, new RGB(0f, 0, 0.3f), .4f);
		Cube.addCube(triangles, -30, 30, 40, 20, 20, 20, new RGB(0, 0.4f, 0), 0.2f); // grün,
																						// klein
